...
# 高优先级队列任务
@taskiq_task(queue="high_priority", timeout=60)
...
@taskiq_task(queue="high_priority", timeout=600)
...
# 低优先级队列任务
@taskiq_task(queue="low_priority", timeout=300)
...
@taskiq_task(queue="low_priority", timeout=1800)
...
@taskiq_task(queue="low_priority", timeout=600)
