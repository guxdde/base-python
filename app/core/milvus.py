...
class MilvusService:
    ...
    async def create_collection_if_not_exists(self) -> Collection:
        ...
        fields = [
            ...
            FieldSchema(name="chunk_type", dtype=DataType.VARCHAR, max_length=16, comment="块类型: content/risk/rating/contact"),
        ...
        try:
            ...
            for i, chunk in enumerate(chunks):
                ...
                data.append({
                    ...
                    "chunk_type": safe_str(metadata.get("chunk_type", "content"), 16),
